...
export default function handler(req, res) {
  let url =
    'https://dem.ri.gov/natural-resources-bureau/marine-fisheries/marine-fisheries-minimum-sizes-possession-limits'
  axios
    .get(url)
    .then((ares) => {
      ...
      $(
        'div.paragraph:nth-child(1) > div:nth-child(1) > table:nth-child(1) > tbody:nth-child(1) > tr'
